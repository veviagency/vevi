      ...
      <div className="container-wide">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center">
            <img alt="Vevi Agency" className="h-10 md:h-12 w-auto rounded-full shadow-none opacity-100 border-solid border-primary border-0" src="/lovable-uploads/1ccdd8c7-1bda-441e-a664-f49c089527e8.png" />
          </Link>
