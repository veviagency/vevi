...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Netlify Forms için kritik: build-time detection var, runtime POST için de form-name olmalı
              ...
              <div className="space-y-8">
                ...
                <div className="bg-secondary rounded-2xl p-6 border border-border">
                  ...
                  <div className="space-y-4">
                    <a
                      href="mailto:kursat@veviagency.com"
                ...
                <div className="bg-secondary rounded-2xl p-6 border border-border">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="https://wa.me/message/F7BQOPPMJP5PG1"
                      target="_blank"
                    ...
                    <a
                      href="https://www.instagram.com/veviagency/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors"
                    ...
                    <a
                      href="https://facebook.com/veviagency"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors"
                      aria-label="Facebook"
                    ...
                    <a
                      href="https://www.youtube.com/channel/UCZe3NrA2NeG-Lbw-dbaUr1g"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors"
                      aria-label="YouTube"
